 ...
 var BASE_URL = 'http://localhost/dashboard/www/System%20HOD%20V4/';
 typeof BASE_URL; // "VARIABLE QUE CONTIENE LA URL CAMBIAR SI SE CAMBIA EL NOMBRE DE LA CARPETA"
 ...
 $(document).ready(function() {
     ...
     switch (modulo.value) {
         ...
         case "consultas-cohorte":
             ...
             dynamic_searchs('cohorte', document.getElementById("search-cohorte"));
             break;
         case "unidades":
         ...
         case "consulta-unidad":
             ...
             dynamic_searchs('unidad', document.getElementById("search-unidad"));
             break;
         case "permisosUser":
             document.getElementById("search-permisos").focus();
             dynamic_searchs('seguridad', document.getElementById("search-permisos"));
             break;
     }
                 ...
                 if (document.getElementById("disponibilidad").style.display == "block") {
                     ...
                     if (document.getElementById("select-turno").value == 0) {
                         ...
                         if (document.getElementById("select-dia").value == 0) {
                             ...
                             $.ajax({
                                 type: 'POST',
                                 url: BASE_URL + 'aula/AggDisponibilidad',
                                 data: {
                                     "nombre_disponibilidad": disponibilidadNueva,
     ...
     switch (modulo.value) {
         case "usuarios":
             ...
             if (cedula.value == "") {
                 ...
                 $.ajax({
                     type: 'POST',
                     url: BASE_URL + 'usuario/BuscarExistenteAjax',
                     data: {
                         'cedula': $("#cedula").val(),
                         'modulo': $("#modulo").val()
                     },
                     ...
                     if (datos != 0) {
                         ...
                         if (nombre.value == "") {
                             if (cont == 0) {
                                 cont = 1;
                                 document.getElementById("mensajeNombre").innerHTML = "El campo nombre de usuario se encuentra vacío";
                                 nombre.focus();
                             }
                         ...
                         if (apellido.value == "") {
                             if (cont == 0) {
                                 cont = 1;
                                 document.getElementById("mensajeApellido").innerHTML = "El campo apellido se encuentra vacío";
                                 apellido.focus();
                             }
                         ...
                         if (correo.value == "") {
                             if (cont == 0) {
                                 cont = 1;
                                 document.getElementById("mensajeCorreo").innerHTML = "El campo correo se encuentra vacío";
                                 correo.focus();
                             }
                         ...
                         if (fecha_n.value == "") {
                             if (cont == 0) {
                                 cont = 1;
                                 document.getElementById("mensajeFecha").innerHTML = "El campo fecha de nacimiento se encuentra vacío";
                                 fecha_n.focus();
                             }
                         ...
                         if (contrasenia.value == "") {
                             if (cont == 0) {
                                 cont = 1;
                                 document.getElementById("mensajeContrasenia").innerHTML = "El campo contraseña se encuentra vacío";
                                 contrasenia.focus();
                             }
                         ...
                         if (confirmar.value == "") {
                             if (cont == 0) {
                                 cont = 1;
                                 document.getElementById("mensajeConfirmar").innerHTML = "Por favor confirme la contraseña";
                                 confirmar.focus();
                             }
                         ...
                         if (contrasenia.value != confirmar.value) {
                             if (cont == 0) {
                                 cont = 1;
                                 document.getElementById("mensajeDosContra").innerHTML = "Las contraseñas no coinciden";
                                 confirmar.focus();
                             }
                         } else if (contrasenia.value == confirmar.value) {
                             cont = 0;
                             document.getElementById("mensajeDosContra").innerHTML = "";
                         }
                         if (rol.value == 0) {
                             if (cedula.value != "" && nombre.value != "" && apellido.value != "" && correo.value != "" && fecha_n.value != "" && contrasenia.value != "" && confirmar.value != "" && contrasenia.value == confirmar.value) {
                                 document.getElementById("mensajeRol").innerHTML = "Debe seleccionar un rol para el usuario";
                                 confirmar.blur();
                             }
                         } else {
         ...
         case "secciones":
             ...
             if (trayecto.value == 0) {
                 ...
                 if (seccionName.value == "") {
                     ...
                     $.ajax({
                         type: 'POST',
                         url: BASE_URL + 'secciones/BuscarExistenteAjax',
                         data: {
                             'seccion': seccionName.value,
                 ...
                 if (aula.value == "") {
                     ...
                     if (ubicacion.value == 0) {
                         ...
                         if (capacidad.value == "") {
                             ...
                             capacidad.blur();
                             if (document.getElementById("disponibilidadesAgregadas").textContent == "" && asignacion.value == 0) {
                                 document.getElementById("validDisponibilidad").innerHTML = "Debe seleccionar una asignación o agregar alguna disponibilidad al aula";
                             } else {
                                 document.getElementById("validDisponibilidad").innerHTML = "";
                                 ...
                                 $.ajax({
                                     type: 'POST',
                                     url: BASE_URL + 'aula/GuardarAjax',
                                     data: {
                                         'aula': aulacompleta,
                                         "disponibilidades": disponibilidadesAgg
                                     },
                                 }).done(function(datos) {
                                     if (datos == 1) {
                                         swal({
             ...
             if (nombreCohorte.value == "") {
                 ...
                 if (fechaCohorte.value == "") {
                     ...
                     if (descripcion.value == "") {
                         ...
                         descripcion.blur();
                         document.getElementById("botonAggUC").onclick = function() {
                             if (document.getElementById("unidadesCohorte").value == 0) {
                                 document.getElementById("validUcAgregadas").innerHTML = "Debe seleccionar una UC";
                             } else {
                                 document.getElementById("validUcAgregadas").innerHTML = "";
                                 uCagregadas.push(document.getElementById("unidadesCohorte").value);
                                 uCagregadas.push('p' + document.getElementById("unidadesCohorte").value);
                                 uCagregadas.push('p' + document.getElementById("unidadesCohorte").value);
                                 var tabla = document.createElement("table");
                                 tabla.style.width = "100%";
                                 var tr = document.createElement("tr");
                                 ...
                                 td.style.textAlign = "center";
                                 var h3 = document.createElement("h3");
                                 var text = document.createTextNode(document.getElementById("unidadesCohorte").options[document.getElementById("unidadesCohorte").selectedIndex].text);
                                 var val = document.getElementById("unidadesCohorte").value;
                                 h3.appendChild(text);
                                 td.appendChild(h3);
                                 var td2 = document.createElement("td");
                                 td2.style.width = "100%";
                                 ...
                                 inputCodigo.placeholder = "Código UC"
                                 var inputHoras = document.createElement("input");
                                 inputHoras.type = "number";
                                 inputHoras.placeholder = "Horas UC";
                                 inputCodigo.className = "form-control";
                                 inputHoras.className = "form-control";
                                 inputCodigo.style.width = "47%";
                                 inputHoras.style.width = "47%";
                                 td3.appendChild(inputCodigo);
                                 td3.innerHTML += ' ';
                                 td3.appendChild(inputHoras);
                                 tr2.appendChild(td3);
                                 tabla.appendChild(tr);
                                 tabla.appendChild(tr2);
                                 var espacio = document.createElement("br");
                                 tabla.appendChild(espacio);
                                 document.getElementById("UCAgregadas").appendChild(tabla);
                                 boton.onclick = function() {
                                     document.getElementById("UCAgregadas").removeChild(tabla);
                                     uCagregadas.splice(uCagregadas.indexOf('p' + val), 1);
                                     uCagregadas.splice(uCagregadas.indexOf('p' + val), 1);
                                     uCagregadas.splice(uCagregadas.indexOf(val), 1);
                                 }
                             }
                         }
                         if (uCagregadas.length == 0) {
                             swal({
                                 title: "No se ha agregado ninguna unidad curricular al cohorte",
                             ...
                             var inputs = document.getElementById("UCAgregadas").querySelectorAll('input');
                             var cont = 0;
                             ...
                             if (cont != 0) {
                                 swal({
                                     title: "Atención",
                                     text: "Todas la UC agregadas deben poseer un código y horas asignadas",
                                     type: "warning",
                                     showConfirmButton: false,
                                     timer: 3000
                                 });
                             } else {
                                 var cohorteComplete = new Object();
                                 cohorteComplete['nroCohorte'] = nombreCohorte.value;
                                 cohorteComplete['fechaCohorte'] = fechaCohorte.value;
                                 cohorteComplete['descripcion'] = descripcion.value;
                                 $.ajax({
                                     type: 'POST',
                                     url: BASE_URL + 'cohorte/guardarAjax',
                                     data: {
                                         'cohorte': cohorteComplete
                                     },
                                 }).done(function(datos) {
                                     var cont = 0;
                                     for (var i = 0; i < uCagregadas.length; i++) {
                                         var cohorteUC = new Object();
                                         cohorteUC['idCohorte'] = datos;
                                         if (!isNaN(uCagregadas[i])) {
                                             cohorteUC['idUC'] = uCagregadas[i];
                                             cohorteUC['codigoUC'] = inputs[i + 1].value;
                                             cohorteUC['horasUC'] = inputs[i + 2].value;
                                             $.ajax({
                                                 type: 'POST',
                                                 url: BASE_URL + 'cohorte/guardarAjaxUc',
                                                 data: {
                                                     'cohorteUC': cohorteUC
                                                 },
                                     ...
                                     swal({
                                         title: "¡Éxito!",
                                         text: "El cohorte " + cohorteComplete['nroCohorte'] + " ha sido registrado exitosamente",
                                         type: "success",
                                         showConfirmButton: false,
                                         timer: 2000
                                     });
                                     setTimeout(function() {
                                         window.location = BASE_URL + "cohorte/Consultas";
                                     }, 2000);
                                 });
                             }
                         }
 ...
 function Siguiente() {
     ...
     if (cedula.value == "") {
         ...
         $.ajax({
             type: 'POST',
             url: BASE_URL + 'docente/BuscarExistenteAjax',
             data: {
                 'cedula': cedula.value
             },
         }).done(function(datos) {
                                                                                     ...
                                                                                     if (experiencia.value == 0) {
                                                                                         ...
                                                                                         if (pregrado.value == "") {
                                                                                             ...
                                                                                             if (titulosAgregados.length == 0) {
                                                                                                 ...
                                                                                                 var textArea = document.getElementById("titulosAgregados").querySelectorAll("textArea");
                                                                                                 var cont = 0;
                                                                                                 ...
                                                                                                 if (cont != 0) {
                                                                                                     swal({
                                                                                                         title: "Atención",
                                                                                                         text: "Todos los títulos adicionales asignados al docente deben llevar una descripción",
                                                                                                         type: "warning",
                                                                                                         showConfirmButton: false,
                                                                                                         timer: 3000
                                                                                                     });
                                                                                                     ...
                                                                                                     for (var i = 0; i < textArea.length; i++) {
                                                                                                         var titleComplete = new Object();
                                                                                                         titleComplete['idTitulo'] = titulosAgregados[i];
                                                                                                         titleComplete['descripcionTitulo'] = textArea[i].value;
                                                                                                         titulosCompletos.push(titleComplete);
                                                                                                     }
                                                                                                 }
                                                                                                 alert(titleComplete);
                                                                                                 //  GuardarAjaxDocentes(infoDocente,ingreso,titulosCompletos);
                                                                                             }
                                                                                         }
                                                                                     }
                                                                                 }
                                                                                         ...
                                                                                         if (titulosAgregados.length == 0) {
                                                                                             ...
                                                                                             if (cont != 0) {
                                                                                                 ...
                                                                                                 for (var i = 0; i < textArea.length; i++) {
                                                                                                     ...
                                                                                                     titleComplete['idTitulo'] = titulosAgregados[i];
                                                                                                     titleComplete['descripcionTitulo'] = textArea[i].value;
                                                                                                     titleComplete['cedula'] = cedula.value;
                                                                                                     GuardarAjaxTitulos(titleComplete);
                                                                                                     document.getElementById("formulario").submit();
                                                                                                 }
                                                                                             }
                                                                                         }
 ...
 function GuardarAjaxDocentes(docente, ingreso, titulos) {
     ...
     $.ajax({
         type: 'POST',
         url: BASE_URL + 'docente/GuardarAjax',
         data: {
             'docente': doc,
             'ingreso': ing
         },
 ...
 function GuardarAjaxTitulos(titulos) {
     $.ajax({
         type: 'POST',
         url: BASE_URL + 'docente/GuardarAjaxTitulos',
         data: {
             "titulos": titulos
         },
     }).done(function(datos) {})
 ...
 function dynamic_searchs(tabla, input) {
     input.onkeyup = function() {
         if (input.value == "") {
             ...
             $.ajax({
                 type: 'POST',
                 url: BASE_URL + tabla + '/DynamicSearch',
                 data: {
                     'clave': input.value
                 },
             }).done(function(datos) {
