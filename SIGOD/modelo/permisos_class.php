...
class Permisos_Class extends Modelo
{
    ...
    public function Registrar($data)
    {
        ...
        try {
            ...
            $datos = $this->conexion->prepare('INSERT INTO permisos_usuario_modulos (usuario, estado, rol_inicio, modulo, ver, consultar,registrar,modificar,reportar,eliminar) VALUES (:usuario, :estado, :rol_inicio, :modulo, :consultar, :registrar, :modificar, :reportar, :eliminar)');
