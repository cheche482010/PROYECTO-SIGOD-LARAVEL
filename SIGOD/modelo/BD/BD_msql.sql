...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-02-2021 a las 22:28:32
...
(2, 21, 'G43', 'Giraluna', '0', 14),
(3, 65, 'gfgdr', 'Hilandera', '0', 54);
...
INSERT INTO `cohortes` (`id_cohorte`, `numero_cohorte`, `fecha_cohorte`, `descripcion_cohorte`, `activo`) VALUES
(2, '15', '2021-10-22', 'nuevo cohorte', 0),
(25, '23', '2012-04-23', 'Cohorte Viejo', 0),
(26, '32', '2013-02-20', 'Cohorte con uC', 0),
(27, '23', '2014-03-23', 'cohorte 2014', 0),
(28, '43', '2015-04-12', 'cohorte 2015', 0);
...
(1, 'DE', 'DedicaciÃƒÂ³n Exclusiva', 42),
...
(1, 'Lunes (MaÃƒÂ±ana)', 1, 1),
(2, 'Lunes (Tarde)', 2, 1),
(3, 'Lunes (Noche)', 3, 1),
(5, 'Martes (MaÃƒÂ±ana) ', 1, 2),
(6, 'Martes (Tarde) ', 2, 2),
(7, 'Martes (Noche) ', 3, 2),
(8, 'MiÃƒÂ©rcoles (MaÃƒÂ±ana) ', 1, 3),
(9, 'MiÃƒÂ©rcoles (Tarde) ', 2, 3),
(10, 'MiÃƒÂ©rcoles (Noche) ', 3, 3),
(11, 'Jueves (MaÃƒÂ±ana) ', 1, 4);
...
('43', 'fdg', 'gfdgfd', 'gdfgfd', 'gfdgfd', 'fd', 'd', '43', 9, 51, 4, 2, 3, 4, 1, ''),
('4353', 'gdfd', 'fdgfd', 'gfdgfd', 'gfdg', 'fdg', 'fdg', '456', 9, 56, 3, 1, 3, 3, 2, ''),
('4354', 'profesorcito', 'perez', 'perez', 'profesorcito', 'fdgf', 'gfdg', '456', 4, 48, 3, 2, 1, 1, 1, ''),
('546', 'fdg', 'fdgfd', 'gfdg', 'fdgfd', 'gfdgfd', 'fdhgfd', '435', 9, 57, 2, 2, 1, 8, 1, ''),
('645', 'fdgfd', 'gfd', 'gfdg', 'fdgfd', 'gfgd', 'fdg', '4343', 9, 58, 2, 1, 1, 8, 2, ''),
('67567', 'gdfg', 'dfgfd', 'gfdgfd', 'gfdg', 'dfgfd', 'dgd', '43543', 8, 55, 2, 3, 3, 4, 2, ''),
('7359870', 'miguel', 'alberto', 'cuicas', 'gomez', 'arbol', 'calle 44 entre 30 y 31', '0251446693', 3, 24, 2, 1, 1, 1, 1, ''),
('75765', 'hfhf', 'hfg', 'fg', 'jgh', 'hjhg', 'hkg', '768', 9, 50, 3, 1, 1, 8, 1, '');
...
INSERT INTO `permisos_usuario_modulo` (`id_permisos_usuario_modulo`, `usuario`, `modulo`, `consultar`, `registrar`, `modificar`, `reportar`, `eliminar`) VALUES
(53, '26577823', 1, 1, 1, 1, 1, 1),
(54, '26577823', 2, 1, 1, 1, 1, 1),
(55, '26577823', 3, 1, 1, 1, 1, 1),
(56, '26577823', 4, 1, 1, 1, 1, 1),
(57, '26577823', 5, 1, 1, 1, 1, 1),
(58, '26577823', 6, 1, 1, 1, 1, 1),
(59, '26577823', 7, 1, 1, 1, 1, 1),
(60, '26577823', 8, 1, 1, 1, 1, 1),
(61, '26577823', 9, 1, 1, 1, 1, 1),
(62, '26577823', 10, 1, 1, 1, 1, 1),
(65, '123456', 1, 1, 1, 1, 1, 1),
(66, '123456', 2, 1, 1, 1, 1, 1),
(67, '123456', 3, 1, 1, 1, 1, 1),
(68, '123456', 4, 1, 1, 1, 1, 1),
(69, '123456', 5, 1, 1, 1, 1, 1),
(70, '123456', 6, 1, 1, 1, 1, 1),
(71, '123456', 7, 1, 1, 1, 1, 1),
(72, '123456', 8, 1, 1, 1, 1, 1),
(73, '123456', 9, 1, 1, 1, 1, 1),
(74, '123456', 10, 1, 1, 1, 1, 1);
...
(1, 'HC', 'Horas Clases'),
(2, 'CI', 'CreaciÃƒÂ³n Intelectual'),
(3, 'IC', 'IntegraciÃƒÂ³n Comunidad'),
(4, 'AA', 'AsesorÃƒÂ­a AcadÃƒÂ©mica '),
(5, 'GA', 'GestiÃƒÂ³n AcadÃƒÂ©mica '),
(6, 'OAA', 'Otras Act. AcadÃƒÂ©micas');
...
INSERT INTO `unidades_curriculares` (`id_unidad_curricular`, `nombre_unidad`, `trayecto`, `fase`, `id_eje_formacion`) VALUES
(4, 'matematicas', '2 ', '2', 2),
(5, 'Arquitectura', '2', '2', 2);
...
--
-- Volcado de datos para la tabla `unidades_curriculares_cohortes`
--

INSERT INTO `unidades_curriculares_cohortes` (`id_unidad_curricular_cohorte`, `id_unidad_curricular`, `id_cohorte`, `codigo_unidad`, `hora_unidad`) VALUES
(36, 5, 26, 'aqeuitect', 34),
(37, 5, 28, 'ARQ22', 4),
(38, 4, 28, 'MAT33', 2);
...
('000001', 'Administrador', 'user', '0543-03-04 00:00:00', 'administrator@gmail.com', 'polo', 1, 'Administrador'),
('00002', 'Usuario', 'User2', '0000-00-00 00:00:00', 'userito@gmail.com', 'usu', 1, 'Usuario'),
('123456', 'administrador', 'usuario', '1999-03-01 00:00:00', 'admin@gmail.com', 'fosforito', 1, 'Super Usuario'),
...
('2657782399', 'Usuario', 'Super', '1997-07-07 00:00:00', 'correito@gmail.com', 'clave', 1, 'Super Usuario'),
('7359870', 'miguel', 'cuicas', '0333-03-23 00:00:00', 'miguelacho@gmail.com', 'lolo', 1, 'Super Usuario'),
('786757', 'jesus', 'bracho', '1998-02-03 00:00:00', 'jesuitobracho@gmail.com', 'lolo', 1, 'Super Usuario');
...
--
ALTER TABLE `aulas_disponibilidades`
  MODIFY `id_aulas_disponibilidades` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `cohortes`
  MODIFY `id_cohorte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `docentes_titulos`
  MODIFY `id_docente_titulo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `ingresos`
  MODIFY `id_ingreso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `permisos_usuario_modulo`
  MODIFY `id_permisos_usuario_modulo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
...
--
ALTER TABLE `unidades_curriculares`
  MODIFY `id_unidad_curricular` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `unidades_curriculares_cohortes`
--
ALTER TABLE `unidades_curriculares_cohortes`
  MODIFY `id_unidad_curricular_cohorte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `permisos_usuario_modulo`
  ADD CONSTRAINT `permisos_usuario_modulo_ibfk_1` FOREIGN KEY (`modulo`) REFERENCES `modulos` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `permisos_usuario_modulo_ibfk_2` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`cedula`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Filtros para la tabla `unidades_curriculares_cohortes`
--
ALTER TABLE `unidades_curriculares_cohortes`
  ADD CONSTRAINT `unidades_curriculares_cohortes_ibfk_1` FOREIGN KEY (`id_cohorte`) REFERENCES `cohortes` (`id_cohorte`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `unidades_curriculares_cohortes_ibfk_2` FOREIGN KEY (`id_unidad_curricular`) REFERENCES `unidades_curriculares` (`id_unidad_curricular`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
