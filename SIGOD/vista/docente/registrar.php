                                            ...
                                            <div class="col-12" >
                                                <div class="form-group">
                                                  ...
                                                  <select class="custom-select form-control" id="titulos">
                                                    ...
                                                    <div style="cursor: pointer" id="boton" onmouseover="this.style.background='black';this.style.color='white';" onmouseout="this.style.background='';this.style.color=''"  class="input-group-addon">
                                            <i >Agregar
                                            </i>
                                        </div>
                                               </div>
