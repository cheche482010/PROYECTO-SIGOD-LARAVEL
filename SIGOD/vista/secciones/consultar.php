                                    ...
                                    <?php foreach($this->seccion as $secciones){   ?> 
                                        <tr onmouseover="this.style.background='#BDD8ED'" onmouseout="this.style.background='white'">
                                            ...
                                            <?php } ?>
                                                ...
                                                <a title="Eliminar sección" onmouseover="this.style.color='#A60303'" onmouseout="this.style.color='red'" class="mdi mdi-delete" style="font-size: 30px; color: red; " type="button" onclick="deleteElement('secciones','<?php echo $secciones['codigo_seccion'];?>','<?php echo $secciones['codigo_seccion'];?> ')"></a>
                                            </td> 
                                        </tr>
                                    <?php } ?>       
                                    </tbody>
