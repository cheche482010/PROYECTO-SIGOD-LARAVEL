                        ...
                        <div class="card-block">
                            <div class="form-group row justify-content-center">
                                ...
                                <div class="col-md-12 m-t-15">
                                    ...
                                    <div>
                                    <h5 style="color:red;" id="mensajeCedula"></h5>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 m-t-15">
                                    ...
                                    <div>
                                    <h5 style="color:red;" id="mensajeNombre"></h5>
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-6 m-t-15">
                                    ...
                                    <div>
                                    <h5 style="color:red;" id="mensajeApellido"></h5>
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-6 m-t-15">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                    <h5 style="color:red;" id="mensajeCorreo"></h5>
                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6 m-t-15">
                                    ...
                                    <div>
                                    <h5 style="color:red;" id="mensajeFecha"></h5>
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-6 ">
                                    ...
                                    <div>
                                    <h5 style="color:red;" id="mensajeContrasenia"></h5>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <div>
                                    <h5 style="color:red;" id="mensajeConfirmar"></h5>
                                    </div>
                                </div>
                            </div>

                            <div>
                                  <center>  <h5 style="color:red;" id="mensajeDosContra"></h5></center>
                                    </div>
                            ...
                            <div class="form-group row  m-t-5">
                                <div class="col-md-12 ">
                                    ...
                                    <div>
                                    <h5 style="color:red;" id="mensajeRol"></h5>
                                    </div>
                                </div>
