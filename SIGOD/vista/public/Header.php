                ...
                <div class="user-profile">
                    ...
                    <div class="profile-text"> <a href="#" class="dropdown-toggle link u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">Usuario<span class="caret"></span></a>
                        <div class="dropdown-menu animated flipInY">
                            ...
                            <div class="dropdown-divider"></div> <a href="<?php echo constant('URL'); ?>login/Salir" class="dropdown-item"><i class="fa fa-power-off"></i> Salir</a>
                        </div>
                    </div>
                </div>
...
<?php if($_SESSION['moduloUsuarios']['consultar']==1){  ?>
                <li class="nav-small-cap">
                    Usuarios
                </li>
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php if($_SESSION['moduloUsuarios']['registrar']==1){  ?>
                        <li>
...
<?php if($_SESSION['moduloSecciones']['consultar']==1){  ?>
                <li class="nav-small-cap">
                    Secciones
                </li>
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <?php if($_SESSION['moduloSecciones']['registrar']==1){  ?>
                        <li>
            ...
            <?php } ?>
<!-- ================================================================================ -->
<?php if($_SESSION['moduloDocentes']['consultar']==1){  ?>
                <li class="nav-small-cap">
                    Docentes
                </li>
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <?php if($_SESSION['moduloDocentes']['registrar']==1){  ?>
                        <li>
            ...
            <?php } ?>
<!-- ================================================================================ -->
<?php if($_SESSION['moduloAulas']['consultar']==1){  ?>
                <li class="nav-small-cap">
                    Aulas
                </li>
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <?php if($_SESSION['moduloAulas']['registrar']==1){  ?>
                        <li>
            ...
            <?php } ?>
<!-- ================================================================================ -->
<?php if($_SESSION['moduloCohortes']['consultar']==0 && $_SESSION['moduloUC']['consultar']==1){  ?>
                <li class="nav-small-cap">
                    Unidad Curricular
                </li>
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <?php if($_SESSION['moduloUC']['registrar']==1){  ?>
                        <li>
            ...
            <?php } ?>
 <!-- ================================================================================ -->
 <?php if($_SESSION['moduloCohortes']['consultar']==1){  ?>
                <li class="nav-small-cap">
                    Cohorte
                </li>
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <?php if($_SESSION['moduloCohortes']['registrar']==1){ ?>
                        <li>
                ...
                <?php } ?>                       
<!-- ================================================================================ -->
<?php if($_SESSION['moduloHorarios']['consultar']==1) { ?>
                <li class="nav-small-cap">
                    Horarios
                </li>
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <?php if($_SESSION['moduloHorarios']['registrar']==1){ ?>
                                <li>
            ...
            <?php } ?>
<!-- ================================================================================ -->
<?php if($_SESSION['moduloSeguridad']['consultar']==1){ ?>
                <li class="nav-small-cap ">
                    Seguridad
                </li>
                <li >
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a href="<?php echo constant('URL'); ?>seguridad/bitacora/" style="color: #BBC5CE;" >
                                Bitacora  
                            </a>
                        </li>
                    </ul>
    ...
    <!-- ================================================================================ -->
    <?php if($_SESSION['moduloNecesidades']['consultar']==1){ ?>
                 <li class="nav-small-cap">
                  Necesidades
                </li>
                <li>
                    <a aria-expanded="false" class="has-arrow" href="#">
                        <i class="mdi mdi-voice">
                        </i>
                        <span class="hide-menu m-l-20 white">
                           Necesidades
                        </span>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <?php if($_SESSION['moduloNecesidades']['registrar']==1) {  ?>
                        <li>
                            <a href="<?php echo constant('URL'); ?>necesidad/Registros/" style="color: #BBC5CE;">
                                Registrar
                            </a>
                        </li>
                    <?php } ?>
                        <li>
                            <a href="<?php echo constant('URL'); ?>necesidad/Consultas/" style="color: #BBC5CE;">
                                Consultar
                            </a>
                        </li>
                    </ul>
 ...
 <!-- ================================================================================ -->
    ...
    <!-- ================================================================================ -->
    <?php if($_SESSION['moduloReportes']['consultar']==1){ ?>
                <li class="nav-small-cap">
                    Reportes
                </li>
                <li style="">
...
<!-- ================================================================================ -->
    ...
    <div class="sidebar-footer" >
        ...
        <!-- item-->
        <a class="link" data-toggle="tooltip" href="<?php echo constant('URL'); ?>login/Salir" title="Cerrar Sesión">
